...
public class MessageRecipientsServiceImpl extends ServiceImpl<MessageRecipientsMapper, MessageRecipients> implements MessageRecipientsService {
    ...
    @Override
    public List<MessageRecipients> findNotReceivedMessageRecipients(Integer messageInfoId, String barcode) {
        return baseMapper.findNotReceivedMessageRecipients(messageInfoId, barcode);
    }
}
